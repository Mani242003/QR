      ...
      <div className="Custom-tab_container">
        <div className="Custom-tab_container_col1">
          ...
          TabLeftItems.map((item,i)=>(
             <CustomTabItemsLeft key={i}  header={item.title} description={item.des} icon={item.icon} />
          ))
         }
        </div>
        ...
        <div className="Custom-tab_container_col3">
     
         {
          TabRightItems.map((item,i)=>(
            <CustomTabItemsRight  key={i} header={item.title} description={item.des} icon={item.icon} />
          ))
         }
